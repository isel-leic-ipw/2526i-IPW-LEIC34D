...
describe("Testing Tasks Management API services with mock users data", () => {
    ...
    describe("Cases of internal error", () => {
        ...
        it("Adding undefined username should return INVALID_USER error", async () => {
            // Arrange
        ...
        it("Adding username abc 2 times; second time should return USER_ALREADY_EXISTS error", async () => {
            // Arrange
